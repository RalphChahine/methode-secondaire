export const guaranteeByLocale = {
  fr: {
    ...
    items: [
      ...
      {
        title: "Première séance orientée plan d'action",
        description:
  ...
  en: {
    ...
    items: [
      ...
      {
        title: "A first session built around a real plan",
        description:
    ...
    profiles: [
      {
        ...
        style: "Explications très structurées, progression calme, haute exigence",
      ...
      },
      {
        ...
        style: "Lien constant entre théorie, unités, phénomènes et formulation des réponses",
        ideal: "Idéal pour les élèves qui ont besoin de transformer la matière en logique claire.",
      },
      {
    ...
    profiles: [
      {
        ...
        style: "Highly structured explanations, calm pacing and strong standards",
      ...
      },
      {
        ...
        style: "Constant links between theory, units, phenomena and answer quality",
        ideal: "Best for students who need the subject to become clear logic instead of memorized fragments.",
      },
      {
...
export const localPageConfigs = {
  montreal: {
    fr: {
      ...
      faq: [
        {
          question: "Le service est-il offert partout à Montréal ?",
          answer:
            "Le tutorat est accessible en ligne partout à Montréal, avec des possibilités en présentiel selon le secteur et la disponibilité du bon profil.",
        },
        {
          question: "Quelles matières sont le plus souvent demandées à Montréal ?",
          answer:
    ...
    en: {
      ...
      faq: [
        {
          question: "Is the service available everywhere in Montreal?",
          answer:
            "Tutoring is available online across Montreal, with in-person possibilities depending on the area and the right tutor profile.",
        },
        {
          question: "Which subjects are most requested in Montreal?",
          answer:
  ...
  laval: {
    fr: {
      ...
      highlights: [
        "Service en ligne partout à Laval",
        "Présentiel possible selon secteur",
        "Compte rendu parent et plan de progression",
      ],
      faq: [
        {
        ...
        },
        {
          ...
          answer:
            "Oui. Le suivi est particulièrement utile pour le rattrapage, la remise à niveau et les périodes où plusieurs chapitres se sont accumulés.",
        },
        {
          question: "Que reçoit un parent après le suivi ?",
          answer:
            "Le parent peut recevoir un résumé simple sur la notion travaillée, le blocage repéré et la prochaine priorité recommandée.",
        },
      ],
    },
    en: {
      ...
      highlights: [
        "Online service across Laval",
        "In person depending on area",
        "Parent summary and progress plan",
      ],
      faq: [
        {
        ...
        },
        {
          ...
          answer:
            "Yes. The service is especially helpful for catch-up work, academic reset periods and accumulated chapters.",
        },
        {
          question: "What does a parent receive after follow-up?",
          answer:
            "Parents can receive a simple summary of the concept covered, the block identified and the next recommended priority.",
        },
      ],
    },
  },
  quebecOnline: {
    fr: {
      ...
      highlights: [
        ...
        "Maths, sciences, physique et chimie",
        "Structure de séance claire et suivi parent",
      ],
      faq: [
        {
          question: "Le tutorat en ligne fonctionne-t-il vraiment pour le secondaire ?",
          answer:
            "Oui, si la séance est bien structurée. L'objectif est de garder un rythme clair, des explications nettes et une progression facile à suivre.",
        },
        {
          question: "Quels besoins sont les plus fréquents en ligne ?",
          answer:
            "Les besoins les plus fréquents concernent les maths du secondaire, les sciences, les examens et les périodes de rattrapage.",
        },
        {
          question: "Pourquoi choisir l'en ligne ?",
          answer:
            "L'en ligne permet d'accéder rapidement au bon profil partout au Québec tout en gardant un suivi rigoureux et simple à organiser.",
        },
      ],
    },
    en: {
      city: "Online across Quebec",
      ...
      highlights: [
        ...
        "Math, science, physics and chemistry",
        "Clear session structure and parent follow-up",
      ],
      faq: [
        {
          question: "Does online tutoring really work for high school students?",
          answer:
            "Yes, when the session is structured well. The goal is to keep explanations clear, pacing steady and progress easy to follow.",
        },
        {
          question: "Which needs are most common online?",
          answer:
            "The most common needs involve high school math, science, exam preparation and catch-up periods.",
        },
        {
          question: "Why choose online tutoring?",
          answer:
            "Online support gives families access to the right tutor profile across Quebec while keeping follow-up rigorous and easy to organize.",
        },
      ],
    },
  },
