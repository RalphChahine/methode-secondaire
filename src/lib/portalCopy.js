...
const portalCopyByLocale = {
  fr: {
    ...
    teamBadge: "Accès équipe",
    teamTitle: "Accédez à l’espace équipe.",
    teamSubtitle: "Cet accès est réservé à l’équipe Méthode Secondaire. Connectez-vous avec le code reçu par courriel.",
    teamLoginHelp: "L’accès équipe est réservé aux personnes autorisées par Méthode Secondaire.",
    ...
    tutorTodayTitle: "Aujourd\u2019hui",
    tutorTodayIntro: "Vos prochaines actions et votre prochaine s\u00e9ance, au m\u00eame endroit.",
    tutorAttentionNote: "Note \u00e0 r\u00e9diger",
    tutorAttentionReply: "R\u00e9ponse \u00e0 envoyer",
    tutorAttentionRequest: "Demande \u00e0 revoir",
    tutorScheduleIntro: "Votre calendrier d\u2019abord, puis vos cr\u00e9neaux ouverts.",
    tutorStudentsTitle: "Mes \u00e9l\u00e8ves",
    tutorStudentsIntro: "Retrouvez chaque \u00e9l\u00e8ve et son contexte avant la s\u00e9ance.",
    tutorMessagesIntro: "Les fils sont regroup\u00e9s par s\u00e9ance et tri\u00e9s par urgence.",
    tutorNoStudents: "Aucun \u00e9l\u00e8ve actif pour le moment.",
    tutorNoMessages: "Aucun message pour le moment.",
    tutorPrepareSession: "Pr\u00e9parer la s\u00e9ance",
    tutorWriteRecap: "\u00c9crire le bilan",
    back: "Retour",
  ...
  en: {
    ...
    teamBadge: "Team access",
    teamTitle: "Access the team space.",
    teamSubtitle: "This access is reserved for the Méthode Secondaire team. Sign in with the code received by email.",
    teamLoginHelp: "Team access is reserved for people authorized by Méthode Secondaire.",
    ...
    tutorTodayTitle: "Today",
    tutorTodayIntro: "Your next actions and next session, in one place.",
    tutorAttentionNote: "Note to write",
    tutorAttentionReply: "Reply to send",
    tutorAttentionRequest: "Request to review",
    tutorScheduleIntro: "Your calendar first, then your open availability.",
    tutorStudentsTitle: "My students",
    tutorStudentsIntro: "Find each student and their context before the session.",
    tutorMessagesIntro: "Threads are grouped by session and sorted by urgency.",
    tutorNoStudents: "No active students yet.",
    tutorNoMessages: "No messages yet.",
    tutorPrepareSession: "Prepare the session",
    tutorWriteRecap: "Write recap",
    back: "Back",
