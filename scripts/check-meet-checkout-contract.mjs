...
async function main() {
  ...
  expect(crmCode.includes('METHODE_SECONDAIRE_CALENDAR_ID_PROPERTY = "METHODE_SECONDAIRE_CALENDAR_ID"'), "CRM: central calendar Script Property is missing")
  expect(crmCode.includes("function resolveManagedCalendarId_()"), "CRM: central calendar resolver is missing")
  expect(crmCode.includes("function resolveCalendarCandidateIds_("), "CRM: session calendar ownership resolver is missing")
  expect(crmCode.includes("calendar_owner_id"), "CRM: session calendar owner persistence is missing")
