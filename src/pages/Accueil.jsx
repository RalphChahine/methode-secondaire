      ...
      <main className="relative z-10 mx-auto w-full max-w-7xl px-5 pb-20 pt-4 sm:px-6 lg:px-8 lg:pb-28 lg:pt-8">
        <HeroShowcase
          ...
          leadForm={{
            ...
            eyebrow: "Étape 1 • Demande parent",
            title: "Remplissez le formulaire.",
            description: "C'est l'étape 1: dites-nous le niveau, la matière et ce qui se passe. On vous rappelle ensuite avec un prochain pas clair.",
        ...
        <ScaleReadinessSection locale="fr" />
